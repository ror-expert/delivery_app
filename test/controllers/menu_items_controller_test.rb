...
class MenuItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create menu_item" do
    assert_difference('MenuItem.count') do
      post menu_items_url, params: { menu_item: { description: @menu_item.description, image: @menu_item.image, menu_id: @menu_item.menu_id, price: @menu_item.price, title: @menu_item.title } }
    end
  ...
  test "should update menu_item" do
    patch menu_item_url(@menu_item), params: { menu_item: { description: @menu_item.description, image: @menu_item.image, menu_id: @menu_item.menu_id, price: @menu_item.price, title: @menu_item.title } }
